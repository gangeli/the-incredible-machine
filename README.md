...
A from-scratch Android remake of Sierra/Dynamix's 1993 contraption puzzle game, designed so a
six-year-old can play it on a tablet: big parts, snapping placement, forgiving drops, one-sentence
goals, a giant Play button, and a celebration when the machine works.

* **Install:** see the [GitHub Pages site](https://gangeli.github.io/the-incredible-machine/) for the APK and step-by-step sideloading instructions.
