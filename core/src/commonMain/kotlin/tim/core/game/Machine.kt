        ...
        when (e.kind) {
            ...
            Effect.Kind.POP -> {
                ...
                for (i in 0 until 8) {
                    ...
                    p.line(e.pos.x + kotlin.math.cos(a) * r * 0.4, e.pos.y + kotlin.math.sin(a) * r * 0.4,
                        e.pos.x + kotlin.math.cos(a) * r, e.pos.y + kotlin.math.sin(a) * r, e.color, 2.5)
                }
                p.alpha = 1.0
            }
            Effect.Kind.SPARKLE, Effect.Kind.STARBURST -> {
                ...
                for (i in 0 until 6) {
                    val a = i * kotlin.math.PI / 3 + t * 2
                    p.fillCircle(e.pos.x + kotlin.math.cos(a) * r, e.pos.y + kotlin.math.sin(a) * r, 3.0 * e.size, Style.YELLOW)
                }
                p.alpha = 1.0
            }
            Effect.Kind.PUFF -> {
